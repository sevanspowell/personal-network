...
#+BEGIN_SRC emacs-lisp
  ...
  (general-define-key
    ...
    "fnr" '((lambda () (interactive) (let ((default-directory "/sudo::")) (async-shell-command "NIXOS_CONFIG=/home/sam/code/devops/personal-network/deployments/personal/orchid/configuration.nix nixos-rebuild switch --keep-failed" "*nixos-rebuild*"))) :which-key "reload-nix-config")
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package lsp-mode
    :init
      ...
      ;; (evil-define-key '(normal motion) lsp-mode-map (kbd ",l") lsp-command-map)
