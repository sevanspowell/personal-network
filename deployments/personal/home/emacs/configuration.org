...
#+BEGIN_SRC emacs-lisp
  ...
  (general-define-key
    ...
    "fnr" '((lambda () (interactive) (let ((default-directory "/sudo::")) (async-shell-command "NIXOS_CONFIG=/home/sam/code/devops/personal-network/deployments/personal/orchid/configuration.nix nixos-rebuild switch --keep-failed"))) :which-key "reload-nix-config")
